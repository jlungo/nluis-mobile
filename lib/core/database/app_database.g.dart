...
class $SyncLogsTable extends SyncLogs with TableInfo<$SyncLogsTable, SyncLog> {
  ...
  static const VerificationMeta _succeededAtMeta = const VerificationMeta(
    'succeededAt',
  );
  @override
  late final GeneratedColumn<int> succeededAt = GeneratedColumn<int>(
    'succeeded_at',
    aliasedName,
    true,
    type: DriftSqlType.int,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('succeeded_at')) {
      context.handle(
        _succeededAtMeta,
        succeededAt.isAcceptableOrUnknown(
          data['succeeded_at']!,
          _succeededAtMeta,
        ),
      );
  ...
  SyncLog map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return SyncLog(
      ...
      succeededAt: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}succeeded_at'],
      ),
    );
  }
...
class SyncLog extends DataClass implements Insertable<SyncLog> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || succeededAt != null) {
      map['succeeded_at'] = Variable<int>(succeededAt);
    }
    return map;
  }
  ...
  factory SyncLog.fromJson(
    ...
    return SyncLog(
      ...
      succeededAt: serializer.fromJson<int?>(json['succeededAt']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'succeededAt': serializer.toJson<int?>(succeededAt),
    };
  }
  ...
  SyncLog copyWith({
    ...
    int? attemptedAt,
    Value<int?> succeededAt = const Value.absent(),
  }) => SyncLog(
    id: id ?? this.id,
    ...
    succeededAt: succeededAt.present ? succeededAt.value : this.succeededAt,
  );
  SyncLog copyWithCompanion(SyncLogsCompanion data) {
    return SyncLog(
      ...
      succeededAt:
          data.succeededAt.present ? data.succeededAt.value : this.succeededAt,
    );
  }
  ...
  bool operator ==(Object other) =>
      ...
      (other is SyncLog &&
          ...
          other.succeededAt == this.succeededAt);
}
...
class SyncLogsCompanion extends UpdateCompanion<SyncLog> {
  ...
  const SyncLogsCompanion({
    ...
    this.succeededAt = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  ...
  static Insertable<SyncLog> custom({
    ...
    return RawValuesInsertable({
      ...
      if (succeededAt != null) 'succeeded_at': succeededAt,
      if (rowid != null) 'rowid': rowid,
    });
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (succeededAt.present) {
      map['succeeded_at'] = Variable<int>(succeededAt.value);
    }
    if (rowid.present) {
      map['rowid'] = Variable<int>(rowid.value);
    }
...
class $$SyncLogsTableFilterComposer
  ...
  ColumnFilters<int> get succeededAt => $composableBuilder(
    column: $table.succeededAt,
    builder: (column) => ColumnFilters(column),
  );
}
...
class $$SyncLogsTableOrderingComposer
  ...
  ColumnOrderings<int> get succeededAt => $composableBuilder(
    column: $table.succeededAt,
    builder: (column) => ColumnOrderings(column),
  );
}
...
class $$SyncLogsTableAnnotationComposer
  ...
  GeneratedColumn<int> get succeededAt => $composableBuilder(
    column: $table.succeededAt,
    builder: (column) => column,
  );
}
