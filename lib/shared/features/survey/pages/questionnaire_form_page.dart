...
import '../../../widgets/form/form_completion_state.dart';
...
class _QuestionnaireFormPageState extends ConsumerState<QuestionnaireFormPage> {
  ...
  void initState() {
    super.initState();
    _currentSurveyId = widget.surveyId;
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          if (widget.isReadOnly)
            Padding(
              padding: EdgeInsets.only(right: ResponsiveUtils.spacing(context, AppConstants.spacingMd)),
              child: Container(
                padding: EdgeInsets.symmetric(
                  horizontal: ResponsiveUtils.spacing(context, AppConstants.spacingMd),
                  vertical: ResponsiveUtils.spacing(context, AppConstants.spacingSm),
                ),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: ResponsiveUtils.spacing(context, AppConstants.spacingXs)),
                    Text(
                      'Imepakiwa',
            ...
            Padding(
              ...
              child: ElevatedButton.icon(
                ...
                icon: Icon(Icons.save_outlined, size: ResponsiveUtils.iconSize(context, 20)),
                label: Text(
                  'Hifadhi Kamili',
                  style: TextStyle(
      ...
      body: questionnaireAsync.when(
          ...
          error:
              (error, stack) => Center(
                child: Padding(
                  padding: EdgeInsets.all(ResponsiveUtils.spacing(context, AppConstants.spacing2xl)),
                  child: Column(
