...
class _ComplianceDashboardPageState extends State<ComplianceDashboardPage> {
  ...
  void initState() {
    super.initState();
    context.read<ProjectsBloc>().add(const LoadProjects('compliance'));
    context.read<SurveyStatsBloc>().add(const LoadSurveyStats('compliance'));
  }
                  ...
                  if (project.hasSurvey)
                    ActionMenuItem(
                      ...
                      onTap: () {
                        ...
                        context.go(
                          '/compliance/projects/${project.id}/surveys?projectName=${Uri.encodeComponent(project.name)}',
                        );
                      },
                    ),
                  if (project.hasZoning)
                    ActionMenuItem(
                      ...
                      onTap: () {
                        Navigator.pop(context);
                        context.go(
                          '/compliance/projects/${project.id}/zoning?projectName=${Uri.encodeComponent(project.name)}',
                        );
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> refreshProjects() async {
      ...
      context.read<ProjectsBloc>().add(const RefreshProjects('compliance'));
    }
