...
final questionnaireRepositoryProvider = Provider<QuestionnaireRepository>((ref) {
  ...
  return QuestionnaireRepositoryImpl(dioClient.dio);
});

// Questionnaire List Provider
final questionnaireListProvider = FutureProvider.family<List<Questionnaire>, QuestionnaireListParams>((ref, params) async {
...
final questionnaireDetailProvider = FutureProvider.family<QuestionnaireDetail, String>((ref, slug) async {
  final repository = ref.watch(questionnaireRepositoryProvider);
